            ...
            <React.Fragment>
                <header className="header">
                    ...
                    <div className="searchInput-container">
                        <input className="searchInput" placeholder="Search for a book..."></input>
                        <button className="searchInput__button"><span>Search<i className="searchInput__icon fa fa-search fa-xs"></i></span></button>
                    </div>
